			...
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text"></i>Notice_list</li>
					</ol>
				</div>
			</div>
						
			<div class="row activity">
				<div class="co"><iframe  width="100%" height="600px;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="notice"></iframe>
				</div>
