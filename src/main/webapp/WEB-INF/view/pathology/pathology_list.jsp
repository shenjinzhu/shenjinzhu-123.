...
<script type='text/javascript'>    
        ...
        function buildTable(sysmptom,pageNumber,pageSize) {
         ...
         if (dataList.length > 0 ) {
             $(dataList).each(function(){//重新生成
                    ...
                    $("#tableBody").append('<td>' + this.sysmptom.substring(0,7) + '</td>');
                    $("#tableBody").append('<td>' + this.pintroduce.substring(0,7) + '</td>');
                    $("#tableBody").append('<td>' + this.medical_use.substring(0,7) + '</td>');
                    $("#tableBody").append('<td>' + this.matters_Needing_Attention.substring(0,7) + '</td>');                   
                    $("#tableBody").append('</tr>');
             	    });  
             	    } else {             	            	
        ...
        $(function(){ 
        	...
        	$('#update').click(function(){
    			...
    			window.location.href="pathology_toUpdate?pathology_id="+text;
    			}
        	});
        	$('#add').click(function(){
