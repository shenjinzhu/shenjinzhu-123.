				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="index.html"><i class="fa fa-laptop"></i><span class="text"> Home</span></a></li>
							<li>
			...
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text"></i><a href="#">Doctor</a></li>
					</ol>
				</div>
			</div>
						
			<div class="row activity">
				<div class="co"><iframe class="f3"  width="100%" height="650px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="doc_be"></iframe>
				</div>
