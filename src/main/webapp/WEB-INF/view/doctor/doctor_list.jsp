...
<script type='text/javascript'>    
        ...
        function buildTable(name,pageNumber,pageSize) {
        	 var url =  urlRootContext + "/doctorList.do"; //请求的网址
        ...
        $(function(){ 
        	$('#delete').click(function(){
    			...
    			if(text){
    			window.location.href="doctorDelete?doctor_id="+text;
    			}
        	...
        	$('#update').click(function(){
    			...
    			window.location.href="doctor_toUpdate?doctor_id="+text;
    			}
        	});
        	$('#add').click(function(){
        		window.location.href="doctor_toAdd";
        	});
        });
    </script>
